...
// ----------------------------------------------------------------------
void plot_mc_phi_ratios_vs_pt(const char* inPhiFile   = "mc_phi_ratios__noGoodElec.root",
                              const char* disCsvFile  = "../unfolding_dis/unfolded_first16.csv",
                              const char* outRootFile = "pt_dependence_noGoodElec.root",
                              const char* outDir      = "pt_dependence_plots_noGoodElec",
                              int         max_ix      = 18,
                              const char* outCsvFile  = "pt_dependence_noGoodElec.csv")  // NEW
{
  gROOT->SetBatch(true);
  ...
  for (Long64_t i=0; i<nEntries; ++i) {
    ...
    double valCorr = (c != 0.0 && ratio != 0) ? ((1 / ratio) / c) : 0.0;
