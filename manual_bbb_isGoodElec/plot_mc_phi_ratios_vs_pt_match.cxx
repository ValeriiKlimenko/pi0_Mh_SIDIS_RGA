...
// ----------------------------------------------------------------------
void plot_mc_phi_ratios_vs_pt(const char* inPhiFile   = "mc_phi_ratios_match.root",
                              const char* disCsvFile  = "../unfolding_dis/unfolded_first16.csv",
                              const char* outRootFile = "pt_dependence_match.root",
                              const char* outDir      = "pt_dependence_plots_match",
                              int         max_ix      = 18,
                              const char* outCsvFile  = "pt_dependence_match.csv")  // NEW
{
  gROOT->SetBatch(true);
