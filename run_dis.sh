...
rootpath="/lustre24/expphy/volatile/clas12/valerii/multi_pi0/data_dis/"
rootprefix="dis_f2018_"

# How many screen sessions to run at once
MAX_PARALLEL=6   # <-- change this if you want more/less concurrency
...
MISSING_LOG="dis_file.log"        # matches your original name
...
for file in "${files[@]}"; do
  ...
  # Your ROOT command
  cmd="clas12root -q 'source/gen_root_files_dis.C(\"$hipopath\", \"$file\", \"${rootpath}${rootprefix}\")'"
